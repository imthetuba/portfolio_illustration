...
# If you want to create pdf reports, you need to install pdfkit and wkhtmltopdf (https://wkhtmltopdf.org/downloads.html).
# Write the following in your terminal to install the required packages and run the script:

# python pip install streamlit infrontconnect pandas plotly pdfkit 
# python streamlit run newtool.py
